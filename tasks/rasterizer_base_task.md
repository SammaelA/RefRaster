...
Это первое задание в этом разделе; на его код будут опираться все последующие задания,
...
* Язык - **C или C++**. Сборка через CMake, проект должен собираться одной
  командой на Linux (gcc/clang). При желании можно использовать и некоторые 
  другие языки (Rust, Zig, Ada, Python+Numba), но тогда функции из шаблона 
  вам придется писать самому. 
...
| 2 | Матричная математика, матрицы вида и проекции | 3 |
| 3 | Буфер глубины, нормализация и вывод 3D-модели | 4 |
| 4 | Нормали (в т.ч. пересчёт) и освещение по Ламберту | 3 |
| 5 | Текстурирование с перспективной коррекцией и фильтрацией | 4 |
| 6 | Несколько моделей и instancing | 3 |
| | **Итого** | **20** |
...
### Пункт 2. Матрицы вида и проекции (3 балла)
...
### Пункт 3. Буфер глубины и вывод 3D-модели (4 балла)
...
### Пункт 4. Нормали и модель освещения Ламберта (3 балла)
