...
|-------|-----------|-------|
| 1 | Окно, реальное время, управление камерой | 4 |
...
| 5 | Процедурный ландшафт: карта высот, движущаяся сетка, нормали, текстуры | 7 |
| | **Итого** | **18** |
...
### Пункт 1. Вывод в окно и управление камерой (4 балла)
